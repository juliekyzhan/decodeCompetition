...
output_dir <- "/Users/kunyazhan/Documents/GitHub/decodeCompetition/output/analysis_output"
...
legis_sum1 <- read_csv("/Users/kunyazhan/Documents/GitHub/decodeCompetition/data/analysis_processed/legis_sum1.csv")
...
# original news data
news_data_path <- "/Users/kunyazhan/Documents/GitHub/decodeCompetition/data/LightGBM_raw/115_118_news_data.csv"
...
# 先去掉 committee_el 或 prof_percentage 的 NA
legis_subset <- legis_merged[!is.na(legis_merged$committee_el) & !is.na(legis_merged$prof_percentage), ]

# 构建虚拟变量
committee_el_dummies <- model.matrix(~ committee_el - 1, data = legis_subset)

# 因变量
y <- legis_subset$prof_percentage
