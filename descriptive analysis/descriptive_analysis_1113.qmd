...
# 可视化：比较两党在不同委员会的专业模式占比
ggplot(party_prof_percentage, aes(x = committee_el, y = avg_prof_percentage, fill = party)) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +
  coord_flip() +
  labs(
    title = "Professional Mode Percentage by Party and Committee",
    x = "Committee",
...
```{r}
#| label: district_analysis_logit_dem_edu
#| echo: false

# 一、核心模型（最简版本）
model11 <- glm(
  is.dom ~ high_edu_share + factor(congress),
  data = dem_legis,
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ high_edu_share +  foreign_born_ratio + 
...
model21a <- glm(
  is.dom ~ high_edu_share + asian_ratio +
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
```{r}
#| label: district_analysis_logit_rep_edu
#| echo: false
...
```{r}
#| label: district_analysis_logit_dem_white_collar
#| echo: false

# 一、核心模型（最简版本）
model11 <- glm(
  is.dom ~ white_collar_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ white_collar_share +  foreign_born_ratio + 
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
model21a <- glm(
  is.dom ~ white_collar_share + asian_ratio +
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_dem_district_white_collar.html"),
  escape = FALSE
)
...
```{r}
#| label: district_analysis_logit_rep_white_collar
#| echo: false
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_rep_white_collar.html"),
  escape = FALSE
)
```
...
```{r}
#| label: district_analysis_logit_dem_blue_collar
#| echo: false

# 一、核心模型（最简版本）
model11 <- glm(
  is.dom ~ blue_collar_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ blue_collar_share +  foreign_born_ratio + 
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
model21a <- glm(
  is.dom ~ blue_collar_share + asian_ratio +
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_dem_district_blue_collar.html"),
  escape = FALSE
)
...
```{r}
#| label: district_analysis_logit_rep_blue_collar
#| echo: false
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_rep_blue_collar.html"),
  escape = FALSE
)
```
...
```{r}
#| label: district_analysis_logit_dem_income
#| echo: false

# 一、核心模型（最简版本）
model11 <- glm(
  is.dom ~ median_household_income_that_year + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ median_household_income_that_year +  foreign_born_ratio + 
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
model21a <- glm(
  is.dom ~ median_household_income_that_year + asian_ratio +
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# age
model31 <- glm(
  is.dom ~ median_household_income_that_year + 
    foreign_born_ratio + asian_ratio +
    white_ratio + black_or_african_american_ratio + agriculture_share + 
    ideology  + gender + chamber + age + factor(congress),
  data = dem_legis,
...
# senirority
model31a <- glm(
  is.dom ~ median_household_income_that_year +  foreign_born_ratio + asian_ratio +
    white_ratio + black_or_african_american_ratio + agriculture_share + 
    ideology  + gender + chamber + seniority + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_dem_district_income.html"),
  escape = FALSE
)
...
```{r}
#| label: district_analysis_logit_rep_income
#| echo: false
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_rep_income.html"),
  escape = FALSE
)
```
...
```{r}
#| label: district_analysis_logit_dem_white_ratio
#| echo: false
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "lm_legis_dem_white_ratio.html"),
  escape = FALSE
)
...
```{r}
#| label: district_analysis_logit_rep_white_ratio
#| echo: false
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "lm_legis_rep_white_ratio.html"),
  escape = FALSE
)
...
```{r}
#| label: district_analysis_logit_dem_asian_ratio
#| echo: false

# 一、核心模型（最简版本）
model11 <- glm(
  is.dom ~ asian_ratio + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ asian_ratio + median_household_income_that_year + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)

model21a <- glm(
  is.dom ~ asian_ratio + high_edu_share +   agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# age
model31 <- glm(
  is.dom ~ asian_ratio + high_edu_share +  agriculture_share + 
    ideology  + gender + chamber + age + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# senirority
model31a <- glm(
  is.dom ~ asian_ratio + median_household_income_that_year +   agriculture_share + 
    ideology  + gender + chamber + seniority + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_dem_asian_ratio.html"),
  escape = FALSE
)
```
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ asian_ratio + blue_collar_share +  foreign_born_ratio + agriculture_share + factor(congress),
  data = rep_legis,
  family = binomial(link = "logit")
) 
...
# age
model31 <- glm(
  is.dom ~ asian_ratio + blue_collar_share +  foreign_born_ratio + agriculture_share + 
    ideology  + gender + chamber + age  + factor(congress),
  data = rep_legis,
  family = binomial(link = "logit")
)
...
# senirority
model31a <- glm(
  is.dom ~ asian_ratio + high_edu_share  +  foreign_born_ratio + agriculture_share + 
    ideology  + gender + chamber + seniority + factor(congress),
  data = rep_legis,
  family = binomial(link = "logit")
)
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_rep_asian_ratio.html"),
  escape = FALSE
)
...
```{r}
#| label: district_analysis_logit_dem_black_ratio
#| echo: false

# 一、核心模型（最简版本）
model11 <- glm(
  is.dom ~ black_or_african_american_ratio + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ black_or_african_american_ratio + median_household_income_that_year +  foreign_born_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)

model21a <- glm(
  is.dom ~ black_or_african_american_ratio + high_edu_share +  foreign_born_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# age
model31 <- glm(
  is.dom ~ black_or_african_american_ratio + high_edu_share +  foreign_born_ratio + agriculture_share + 
    ideology  + gender + chamber + age + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_dem_black_ratio.html"),
  escape = FALSE
)
```

```{r}
#| label: district_analysis_logit_rep_black_ratio
#| echo: false
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ black_or_african_american_ratio + blue_collar_share +  foreign_born_ratio + agriculture_share + factor(congress),
  data = rep_legis,
  family = binomial(link = "logit")
) 
...
# age
model31 <- glm(
  is.dom ~ black_or_african_american_ratio + blue_collar_share +  foreign_born_ratio + agriculture_share + 
    ideology  + gender + chamber + age  + factor(congress),
  data = rep_legis,
  family = binomial(link = "logit")
)
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_rep_black_ratio.html"),
  escape = FALSE
)
```
...
```{r}
#| label: district_analysis_logit_dem_foreign_born
#| echo: false

# 一、核心模型（最简版本）
model11 <- glm(
  is.dom ~ foreign_born_ratio + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~  foreign_born_ratio  +  high_edu_share + 
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
model21a <- glm(
  is.dom ~ foreign_born_ratio  +  blue_collar_share + 
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_dem_district_foreign_born.html"),
  escape = FALSE
)
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ foreign_born_ratio + blue_collar_share +  asian_ratio +
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = rep_legis,
  family = binomial(link = "logit")
) 
...
# age
model31 <- glm(
  is.dom ~ foreign_born_ratio + white_collar_share + 
    asian_ratio +
    white_ratio + black_or_african_american_ratio + agriculture_share + 
    ideology  + gender + chamber + age  + factor(congress),
  data = rep_legis,
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_rep_foreign_born.html"),
  escape = FALSE
)
```
...
```{r}
#| label: district_analysis_logit_dem_farmer_share
#| echo: false

# 一、核心模型（最简版本）
model11 <- glm(
  is.dom ~ agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ agriculture_share + foreign_born_ratio  +  high_edu_share + 
...
model21a <- glm(
  is.dom ~ agriculture_share + foreign_born_ratio  +  blue_collar_share + 
    white_ratio + black_or_african_american_ratio +  factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
)
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_dem_district_agri.html"),
  escape = FALSE
)
...
# 二、扩展控制模型（控制选区结构异质性）
model21 <- glm(
  is.dom ~ agriculture_share +  foreign_born_ratio + blue_collar_share +  asian_ratio +
    white_ratio + black_or_african_american_ratio +  factor(congress),
  data = rep_legis,
  family = binomial(link = "logit")
) 
...
# age
model31 <- glm(
  is.dom ~ agriculture_share + foreign_born_ratio + white_collar_share + 
    asian_ratio +
    white_ratio + black_or_african_american_ratio + 
    ideology  + gender + chamber + age  + factor(congress),
  data = rep_legis,
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_rep_agri.html"),
  escape = FALSE
)
...
# 看党派与委员会专业性的交互项
full_model <- glm(
  is.dom ~ committee_el*party + gender + chamber + seniority + factor(congress),
  data = legis_merged1,
  family = binomial()
)
summary(full_model)
...
```{r}
#| label: individual_analysis_logit_dem_ideology
#| echo: false

# 初始模型
dem_model <- glm(is.dom ~ ideology + factor(congress),
                 data = dem_legis,
                 family = binomial())
...
# 加入个人特质作为控制变量
dem_model1 <- glm(is.dom ~ ideology +  gender + chamber + age + factor(congress),
                 data = dem_legis,
                 family = binomial())
...
# 加入选区变量作为控制变量
dem_model2 <- glm(
  is.dom ~ ideology +  gender + chamber + age + 
    high_edu_share +  foreign_born_ratio + asian_ratio +
    white_ratio + black_or_african_american_ratio + agriculture_share + factor(congress),
  data = dem_legis,
  family = binomial(link = "logit")
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_dem_ideology.html"),
  escape = FALSE
)
...
# 五、可视化：边际效应（Marginal Effects）
# 高等教育比例的边际效应
ideology_effect <- ggpredict(dem_model, terms = "ideology [all]")
...
# 高等教育比例的边际效应（去掉income）
ideology_effect1 <- ggpredict(dem_model1, terms = "ideology [all]")
...
# 控制个人特征之后的high_education的边际效应
ideology_effect2 <- ggpredict(dem_model2, terms = "ideology [all]")
...
```{r}
#| label: individual_analysis_logit_rep_ideology
#| echo: false

# 初始模型
rep_model <- glm(is.dom ~ ideology + factor(congress),
                 data = rep_legis,
                 family = binomial())
...
# 加入个人特质作为控制变量
rep_model1 <- glm(is.dom ~ ideology +  gender + chamber + age + factor(congress),
                 data = rep_legis,
                 family = binomial())
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "logit_legis_rep_ideology.html"),
  escape = FALSE
)
...
# 8. dem prof_percentage lm model

## 8.1 high_edu

```{r}
#| label: district_analysis_legis_dem_edu
#| echo: false
...
```{r}
#| label: district_analysis_linear_dem_white_collar
#| echo: false
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "linear_legis_dem_district_white_collar.html"),
  escape = FALSE
)
...
```{r}
#| label: district_analysis_linear_dem_blue_collar
#| echo: false
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "linear_legis_dem_district_blue_collar.html"),
  escape = FALSE
)
...
```{r}
#| label: district_analysis_linear_dem_income
#| echo: false
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "linear_legis_dem_district_income.html"),
  escape = FALSE
)
...
```{r}
#| label: district_analysis_linear_dem_white_ratio
#| echo: false
...
```{r}
#| label: district_analysis_linear_dem_asian_ratio
#| echo: false
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "linear_legis_dem_asian_ratio.html"),
  escape = FALSE
)
...
```{r}
#| label: district_analysis_linear_dem_black_ratio
#| echo: false
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "linear_legis_dem_black_ratio.html"),
  escape = FALSE
)
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "linear_legis_dem_district_foreign_born.html"),
  escape = FALSE
)
...
modelsummary(
  ...
  fmt = 3,
  stars = TRUE,
  output = file.path(output_dir, "linear_legis_dem_district_agri.html"),
  escape = FALSE
)
